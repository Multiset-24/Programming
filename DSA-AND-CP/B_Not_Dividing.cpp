...
void jarvis(){
   ...
   for(int i=1;i<=n;i++){// to make sure that element is atleast 2 so we can protect from division of 1 which can not be prevented
        v[i]++;
   }
...
11.Always check for edge cases .
