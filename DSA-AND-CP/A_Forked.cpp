...
void jarvis(){
   ...
   cin>>Xq>>Yq;
    ...
    vector<vector<int>>dir={{a,b},{a,-b},{-a,b},{-a,-b},{b,a},{b,-a},{-b,a},{-b,-a}};
    int points=0;
    for(int i=0;i<8;i++){//yaar input to shi se leta km se 8 hoga 7 nhi
        int Xn=Xk+dir[i][0];
        int Yn=Yk+dir[i][1];
