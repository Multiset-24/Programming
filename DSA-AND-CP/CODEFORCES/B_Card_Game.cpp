...
void jarvis()
{
    ...
    ways+=((a>c)&&(b>=d));//way 1 of choosing
    ways+=((a>d)&&(b>=c));//way 2 of choosing
    ways+=((b>c)&&(a>=d));//way 3 of choosing
    ways+=((b>d)&&(a>=c));//way 4 of choosing
    ways+=((a==c)&&(b>d));//way 5 of choosing
    ways+=((a==d)&&(b>c));//way 6 of choosing
    ways+=((b==c)&&(a>d));//way 7 of choosing
    ways+=((b==d)&&(a>c));//way 8 of choosing
