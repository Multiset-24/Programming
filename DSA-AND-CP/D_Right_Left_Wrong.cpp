...
int rec(int i,int j,vector<int>&num,vector<char>&dir,vector<int>&prefix){
    if(i>=j)return 0;
    ...
    return (prefix[j]-prefix[i-1])+rec(i,j,num,dir,prefix);
}
void jarvis()
{
    int n;
    ...
    cout<<rec(0,n+1,num,dir,prefix)<<endl;
