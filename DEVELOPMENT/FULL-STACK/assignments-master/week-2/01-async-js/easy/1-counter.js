...
let interval=setInterval(()=>{
    ...
    console.log(counter);
    if(counter==0){
        clearInterval(interval);//clearInterval is a function that stops the interval from calling the function syntax clearInterval(intervalID)
        //intervalID is the ID value returned by setInterval() function
